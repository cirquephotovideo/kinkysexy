# 🎯 Plan — Agent scraper contacts ultra-puissant pour Kinky
...
|---|---|---|---|
| **Site web public** | Crawl polite-fetch + Jina Reader fallback (déjà en place dans Kinky) | Faible — ToS varient | 800ms/host |
...
**Setup Kinky pur (gratuit + Gemini seul)** : ~$5-15/mois pour 1000 contacts/mois.
