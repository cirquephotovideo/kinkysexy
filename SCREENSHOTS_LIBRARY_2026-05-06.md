# 📸 Bibliothèque de screenshots — KinkySexy
...
- **Observé** : hero gradient violet-bleu-rose, ticker dons (5€/10€), barre comportant "Soutenez le mouvement / Chaque don fait la différence / Aidez-nous à diffuser l'affiche partout dans le monde", logo Kinky avec cœur arc-en-ciel.
...
- **Bouton flottant** : SOS (rouge, en bas-gauche) · Demandez à Kinky (rose, en bas-droite)
...
- **Observé** : "Espaces de discussion thématiques pour la communauté Kinky"
...
- **Footer visible** : #KinkySexy · Le mouvement · Ressources · Mon compte
...
- **Produits visibles** : T-shirt arc-en-ciel "KinkySexy" 35€ · Bougie parfumée "Vitrail — Encens & Oud" · Mug céramique "Foi & Diversité" 17€ · Tote bag canvas "Kinky" 15€
...
- **Grille photos** : visuels Kinky (cœurs arc-en-ciel), photo "Paris", photos églises avec posters Kinky (Helsinki, Florence, etc.)
...
- **Observé** : titre "⭐ Membre+", "Soutiens Kinky à long terme. 4€/mois ou 40€/an"
- **2 plans visibles** : Mensuel 4€/mois · Annuel 40€/an (-17%)
- **Avantages listés** : Aucune publicité · Badge "Membre+" visible sur ton profil · Accès anticipé aux nouveaux événements (24h avant) · Statistiques perso (impact témoignages, partages, soutiens) · Bon de réduction 15% boutique Kinky · Accès aux 50 thèmes saisonniers (sinon limité à 10) · Studio IA Pro illimité (sinon 10/mois)
...
- **Observé** : Hero noir "🌈 KinkySexy — Live · 6 mai 2026 à 12:41"
...
- **Observé** : interface réseau social complète, header "Kinky Connect" + recherche, 3 modes en haut (Communauté actif / Rencontres / Pro)
...
- **Toggles features** :
  - Kinky Soul (OFF) — La voix du site, réflexion 1ère personne par IA chaque jour
...
- **Observé** : Hero gradient pastel rose-violet-vert, "MANUEL SUPER-ADMIN — 🌈 KinkySexy"
