# KinkySexy — iOS / iPadOS natif (SwiftUI pur)
...
```bash
open ~/Desktop/godlovedirect/apps/ios-native/KinkySexy.xcodeproj
```
...
3. Le bundle ID `com.pixeeplay.kinkysexy` peut nécessiter un suffixe (ex: `.tonpseudo`) si déjà utilisé
4. Cmd+R
...
│   └── ChatView.swift           # Chat IA "Demandez à Kinky"
└── Assets.xcassets
```
...
Tous backed par https://kinky.pixeeplay.com.
