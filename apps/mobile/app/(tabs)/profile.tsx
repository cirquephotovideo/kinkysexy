  ...
  return (
    <ScrollView className="flex-1 bg-brand-dark p-6">
      ...
      <Section title="🌟 Engagement">
        ...
        <Item icon="sparkles" label="Demandez à Kinky (chat IA)" onPress={() => router.push('/chat')} />
      </Section>
      ...
      <Section title="ℹ️ À propos">
        ...
        <Item icon="mail" label="Contact" onPress={() => Linking.openURL('mailto:hello@kinkysexy.com')} />
      </Section>

      <Text className="text-white/30 text-xs text-center my-8">
        KinkySexy v1.0.0 · pixeeplay.com
      </Text>
    </ScrollView>
  );
}
