      ...
      <ScrollView ref={scrollRef} className="flex-1 px-4 py-4">
        {history.length === 0 && (
          <View className="mt-8">
            <Text className="text-white/70 text-center mb-6">
              ✨ Bonjour 🌈 Je suis Kinky, l'assistant IA inclusif. Je réponds avec apaisement aux questions sur la foi et la diversité.
            </Text>
        ...
        {busy && (
          <View className="self-start bg-zinc-900 border border-zinc-800 rounded-2xl px-3 py-2 flex-row items-center gap-2">
            ...
            <Text className="text-white/60 text-xs">Kinky réfléchit…</Text>
          </View>
        )}
      </ScrollView>
