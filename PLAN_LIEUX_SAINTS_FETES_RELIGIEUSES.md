...
**Date :** 6 mai 2026 · **Pour :** KinkySexy

---

## 🎯 Objectif

Faire de Kinky **la** référence inclusive pour :
...
Toggle additionnel : **"Inclusif vérifié"** (badge Kinky) vs "Tolérant connu" vs "Non vérifié".
...
- **Détail d'un événement** : description, signification, comment Kinky le célèbre, liste des lieux participants, bouton "Rejoindre la prière virtuelle"
...
- Badge "Pèlerin Kinky" quand un chemin est terminé
