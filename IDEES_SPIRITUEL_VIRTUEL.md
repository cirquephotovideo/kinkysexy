...
### 1.3 — Carte d'authenticité "Kinky inclusive verified"
**Quoi :** badge officiel Kinky attribué après audit (formulaire d'auto-évaluation par le lieu + témoignages ≥3 utilisateurs LGBT + vérification admin). Affiché en gros sur la fiche du lieu.
...
**Effort :** moyen (déjà 80 % fait avec "Demandez à Kinky")
**Valeur :** ⭐⭐⭐⭐⭐
...
**Quoi :** quand un événement homophobe/transphobe majeur se produit (ex. attentat, loi liberticide), Kinky propose automatiquement une veillée live 24h dans toutes les langues, agréée par les 7 cercles. Page dédiée éphémère, bougies virtuelles + intentions.
...
**Quoi :** chaque 1er décembre, Kinky coordonne une veillée mondiale toutes confessions, avec mémorial des disparus du sida (mur photos + intentions). Lecture des noms en direct.
**Effort :** moyen
...
| 6 | Carte d'authenticité Kinky verified | Moyen | ⭐⭐⭐⭐⭐ |
...
**Mois 2 (juillet)**
- Carte d'authenticité Kinky verified (workflow complet)
