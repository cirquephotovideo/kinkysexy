...
│                                                                   │
│  ┌────────────────────────────────────────────────────────────┐  │
│  │  TENANT 'kinky' (existant — KinkySexy)              │  │
│  │  - DB: postgresql://tenant_kinky                              │  │
│  │  - MinIO bucket: tenant-kinky/                                │  │
...
### Tables par tenant DB (réplique de la struct Kinky actuelle, isolée)
...
## 5. 🎨 Builder visuel (extension du Page Builder Kinky)

Tout ce que tu as déjà sur Kinky devient le builder du SaaS, avec en plus :
...
## 6. 🤖 IA features (extension de ce que Kinky a déjà)
...
- Webmail intégré (déjà fait sur Kinky)
...
### Forms / CRM
- Native CRM (déjà fait sur Kinky : Lead + LeadInteraction)
...
### Phase 2 — Builder porté depuis Kinky (semaine 3-4)
...
1. **Nom** : Pixeesite ? Builderly ? Pageforge ? Kinkysite ? → branding
...
6. **Branding et tone of voice** : warm-friendly comme Kinky ? techie comme Vercel ? quirky comme Linear ?
...
> Forke Kinky, ajoute une colonne `orgId` à toutes les tables métier, mets
