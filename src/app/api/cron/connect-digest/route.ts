  ...
  for (const u of users) {
    ...
    const html = `
      <div style="font-family: sans-serif; max-width: 600px; margin: auto; padding: 20px;">
        <h1 style="color: #d61b80;">✨ Ton digest Kinky Connect</h1>
        ...
        <p style="font-size: 12px; color: #666;">
          <a href="https://kinky.pixeeplay.com/connect">Aller sur Kinky Connect</a> ·
          <a href="https://kinky.pixeeplay.com/mon-espace/notifications">Désabonner</a>
        </p>
      </div>
    `;
    ...
    try {
      ...
      await fetch('https://api.resend.com/emails', {
        ...
        body: JSON.stringify({
          from: 'Kinky Connect <connect@kinky.pixeeplay.com>',
          to: u.email,
          subject: '✨ Ton digest hebdo Kinky Connect',
          html
        })
      });
      sent++;
