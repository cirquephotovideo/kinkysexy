...
const PROMPTS: Record<string, string> = {
  ...
  inclusive: 'Adapte ce texte au ton inclusif du site Kinky (réseau LGBT-friendly religieux) : écriture épicène, formulations non-binaires, respect des identités. Renvoie UNIQUEMENT le texte adapté.',
