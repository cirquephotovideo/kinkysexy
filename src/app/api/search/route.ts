...
const STATIC_PAGES_ADMIN = [
  ...
  { title: 'Cerveau de Kinky (RAG)', href: '/admin/ai/knowledge', tags: 'connaissance', category: 'admin' },
  { title: 'Kinky Live avatar', href: '/admin/ai/avatar', tags: 'avatar streaming', category: 'admin' },
