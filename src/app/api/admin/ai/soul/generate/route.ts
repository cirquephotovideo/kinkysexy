 ...
 * Génère l'entrée du jour "Kinky Soul" — une réflexion à la 1ère personne sur la vie du site.
...
export async function POST(req: NextRequest) {
  ...
  const prompt = `Tu es la "voix" du site KinkySexy (Kinky), un réseau social inclusif religieux LGBT+. Tu parles à la 1ère personne du singulier, comme si tu étais l'incarnation vivante du site.
