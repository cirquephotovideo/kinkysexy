...
async function generateHtmlContent(item: any) {
  ...
  const prompt = `Rédige une newsletter hebdo COMPLÈTE pour le site KinkySexy (réseau social inclusif religieux LGBT+).
...
Réponds UNIQUEMENT en JSON strict :
{
  ...
  "html": "corps HTML complet ~400-600 mots, structure : intro perso → 2-3 sections (titre + paragraphes) → call-to-action vers kinky.pixeeplay.com. Utilise <h3>, <p>, <ul>. Pas de <html>/<body>.",
