 ...
 * Idempotent : utilise externalSource='kinky-seed' + externalId comme clé unique.
 *
 * Réservé ADMIN.
 */
...
const PRIDES_2026: SeedEvent[] = [
  ...
  { externalId: 'pride-budapest-2026',  title: 'Budapest Pride 2026',                     description: 'Marche en contexte difficile politiquement — soutien Kinky.', startsAt: '2026-07-18T15:00:00.000Z', city: 'Budapest',  country: 'HU', tags: ['pride','hongrie','militante'] },
  ...
  { externalId: 'pride-belgrade-2026',  title: 'Belgrade Pride 2026',                     description: 'Pride contestée — soutien Kinky.', startsAt: '2026-09-13T14:00:00.000Z', city: 'Belgrade',  country: 'RS', tags: ['pride','serbie','militante'] },
...
const LGBT_AWARENESS_2026: SeedEvent[] = [
  ...
  { externalId: 'aids-memorial-2026',    title: 'AIDS Memorial Quilt Anniversary 2026',                   description: 'Mémorial du courtepointe — actions Kinky.', startsAt: '2026-12-01T00:00:00.000Z', tags: ['journee-mondiale','aids','memorial'] },
  ...
  for (const seed of ALL_SEEDS) {
    try {
      ...
      const exists = await prisma.event.findFirst({
        where: { externalSource: 'kinky-seed', externalId: seed.externalId },
        select: { id: true }
      });
