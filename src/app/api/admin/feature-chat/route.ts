...
const SYSTEM = `Tu es Architecte Produit pour le projet "KinkySexy" (kinky.pixeeplay.com), un réseau social interreligieux LGBT+.
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const coworkPrompt = `Continue le développement de Kinky (kinky.pixeeplay.com). Voici une nouvelle feature à implémenter :
...
Implémente cette feature en suivant le plan. Crée les fichiers, push vers main, et confirme quand c'est fini.`;
    ...
    notify({
      ...
      url: 'https://kinky.pixeeplay.com/admin/feature-chat',
      level: 'info',
