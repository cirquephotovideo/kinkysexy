  ...
  try {
    ...
    const html = `
      <div style="font-family:system-ui;max-width:600px;margin:0 auto;padding:24px;background:#fff;color:#222">
        <h1 style="color:#d61b80">🔑 Ton accès Kinky Admin</h1>
        ...
        <p style="text-align:center;margin:32px 0">
          <a href="https://kinky.pixeeplay.com/admin/login" style="display:inline-block;background:#d61b80;color:white;padding:12px 24px;border-radius:99px;text-decoration:none;font-weight:bold">
            Se connecter →
          </a>
        </p>
      </div>
    `;
    await sendEmail(invitation.email, '🔑 Ton accès Kinky Admin (mot de passe temporaire)', html, { type: 'admin-notify' }).catch(() => {});
