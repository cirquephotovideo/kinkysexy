 ...
 *
 * Setup :
 * 1. Configure events@kinky.pixeeplay.com dans Resend/Mailgun → forward webhook ici
 * 2. Dans Gmail, créer une règle : From:facebookmail.com → Forward to events@kinky.pixeeplay.com
