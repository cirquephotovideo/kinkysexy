...
<title>Rapport Kinky Live · ${fmt(s.venues)} lieux · ${fmt(s.users)} membres</title>
<meta name="description" content="État live du projet KinkySexy, données extraites de la base de production." />
...
<div class="container">
  <div class="hero">
    ...
    <p style="margin-top:16px;">
      ...
      <a class="btn" href="https://kinky.pixeeplay.com">🌐 Voir le site</a>
    </p>
  </div>
  ...
  <table>
    <thead><tr><th>Fonction</th><th>Kinky</th><th>Facebook</th><th>Tinder</th><th>LinkedIn</th></tr></thead>
    <tbody>
  ...
  ${[
    ...
    ['IA (Demandez à Kinky, Studio, Avatar)', 82],
  ...
  <div class="footer">
    ...
    <p style="margin-top:8px;">🌈 <a href="https://kinky.pixeeplay.com">kinky.pixeeplay.com</a> — Dieu est amour.</p>
  </div>
</div>
</body>
</html>`;
