...
async function loadModules(): Promise<Module[]> {
  ...
  return [
    ...
    { category: 'IA', name: 'Demandez à Kinky (chat)', status: 'live', stats: 'Widget chat avec RAG sur knowledge base' },
...
<title>📊 Audit Kinky complet · ${completion}% complétion</title>
