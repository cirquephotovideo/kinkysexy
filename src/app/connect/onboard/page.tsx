      ...
      <div className="backdrop-blur-2xl bg-white/[0.06] border border-white/10 rounded-3xl p-6 shadow-2xl">
        ...
        {step === 5 && (
          <div className="text-center py-8">
            ...
            <p className="text-sm text-zinc-400">Ton profil Kinky Connect est créé. Tu peux le modifier à tout moment depuis <code className="text-fuchsia-300">/mon-espace</code>.</p>
          </div>
        )}
