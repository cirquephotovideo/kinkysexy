...
export const metadata = { title: 'Site map admin · Kinky' };
...
const PUBLIC_GROUPS: RouteGroup[] = [
  {
    ...
    routes: [
      ...
      { href: '/message', label: 'Le message', desc: 'Manifeste Kinky' },
...
const ADMIN_GROUPS: RouteGroup[] = [
  ...
  },
  {
    ...
    routes: [
      ...
      { href: '/admin/ai/avatar',               label: 'Avatar IA (Kinky Live)', isAdmin: true },
  ...
  return (
    <div className="p-6 md:p-8 max-w-6xl space-y-6">
      <header className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl md:text-3xl font-display font-bold leading-none">Site map Kinky</h1>
