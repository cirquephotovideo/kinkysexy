...
wget -qO- --header="X-Cron-Secret: $CRON_SECRET" --post-data="" "http://localhost:3000/api/admin/ai/manual/email?send=1"
      ...
      <div className="bg-zinc-900/50 border border-zinc-800 rounded-xl p-4 text-xs text-zinc-400">
        ...
        <ul className="space-y-1 font-mono">
          <li><a href="/api/manuals/user" target="_blank" className="text-cyan-300 hover:underline">https://kinky.pixeeplay.com/api/manuals/user</a></li>
          <li><a href="/api/manuals/admin" target="_blank" className="text-cyan-300 hover:underline">https://kinky.pixeeplay.com/api/manuals/admin</a></li>
          <li><a href="/api/manuals/superadmin" target="_blank" className="text-cyan-300 hover:underline">https://kinky.pixeeplay.com/api/manuals/superadmin</a></li>
        </ul>
