      ...
      <section className="bg-zinc-900/60 border border-zinc-800 rounded-2xl p-5">
        ...
        <div className="grid md:grid-cols-3 gap-3 text-xs">
          ...
          <div className="bg-violet-500/10 border border-violet-500/30 rounded-xl p-3">
            ...
            <p className="text-violet-100/80">100% éthique, bio, vegan, packaging recyclé, made in France/NL. Aligné Kinky ❤️ — marges + fines.</p>
          </div>
      ...
      <section className="bg-zinc-900/60 border border-zinc-800 rounded-2xl p-5">
        ...
        <ol className="space-y-3 text-sm">
          ...
          <li className="flex gap-3">
            ...
            <div>
              <strong className="text-white">Dans la fiche produit Kinky</strong> (Boutique → Produits), tu choisis le fournisseur et tu colles l'ID variant + le coût d'achat. La marge s'affiche en direct.
            </div>
          </li>
          <li className="flex gap-3">
