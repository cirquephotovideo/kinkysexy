    ...
    <div className="max-w-4xl mx-auto p-6">
      ...
      {tab === 'smtp' && (
        <Section title="Option 2 — Gmail SMTP relay (envoi gratuit 500/jour)" cost="0 €/mois">
          <p className="text-sm text-zinc-300 mb-3">Utilise ton compte Gmail (perso ou Workspace) comme relais d'envoi. Newsletters + notifs Kinky passent par Gmail.</p>
          ...
          <Step n={2} title="Créer un App Password">
            <ExtLink url="https://myaccount.google.com/apppasswords" /> → Choisir « Autre » → "Kinky Server" → copier les <b>16 caractères</b>
          </Step>
          <Step n={3} title="Coller dans /admin/settings → Gmail SMTP relay">
            <ul className="text-xs space-y-1 mt-2">
              ...
              <li><b>From</b> : <code>"Kinky" &lt;contact@{domain}&gt;</code></li>
            </ul>
          </Step>
      ...
      {tab === 'workspace' && (
        <Section title="Option 3 — Gmail Workspace (le top, 6€/mois/user)" cost="6 €/mois/user">
          ...
          <Step n={6} title="Connecter à Kinky">
