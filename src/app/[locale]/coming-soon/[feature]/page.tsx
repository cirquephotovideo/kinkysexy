...
const FEATURES: Record<string, { title: string; desc: string; eta: string }> = {
  ...
  'mode-calculatrice': { title: '🔢 Mode calculatrice', desc: 'Pour les pays hostiles : l\'app ressemble à une calculatrice, code pour ouvrir Kinky.', eta: 'Roadmap H2 2026' },
  ...
  'marketplace': { title: '🛍 Marketplace artisans LGBT', desc: 'Créateur·rices indépendant·es vendent leurs œuvres, Kinky prend 8%.', eta: 'Roadmap Q4 2026' },
  'crowdfunding': { title: '💰 Crowdfunding intégré', desc: 'Projets LGBT (films, livres, assos) lancent des campagnes sur Kinky.', eta: 'Roadmap 2027' },
  ...
  'temoignage-ia': { title: '🎬 Témoignage vidéo IA', desc: 'Tu écris ton histoire en texte, l\'avatar Kinky la lit en vidéo personnalisée.', eta: 'Roadmap Q3 2026' },
  'kinky-local': { title: '🌆 Kinky Local par ville', desc: 'Pages dédiées Paris/Lyon/Bruxelles/Berlin/NYC avec leur rédac et leurs events.', eta: 'Roadmap H2 2026' },
  ...
  'wrapped': { title: '✨ Wrapped Kinky annuel', desc: 'Recap fin d\'année style Spotify : tes témoignages, soutiens, partages.', eta: 'Roadmap Décembre 2026' },
  'widget': { title: '🔌 Widget embeddable', desc: '<script src="kinky.js"> pour afficher derniers témoignages sur d\'autres sites.', eta: 'Roadmap Q2 2026' }
};
...
export default async function ComingSoon({ params }: { params: Promise<{ feature: string }> }) {
  ...
  return (
    <main className="container-wide py-20 max-w-2xl text-center">
      ...
      <p className="text-[11px] text-zinc-500 mt-6">Cette feature est dans la roadmap Kinky V3. Tu veux qu'on accélère ? <Link href="/contact" className="underline">Contacte-nous</Link>.</p>
    </main>
  );
}
