...
export const metadata = { title: 'Programme parrainage — Kinky' };
  ...
  return (
    <main className="container-wide py-12 max-w-3xl">
      <header className="text-center mb-8">
        ...
        <p className="text-zinc-400 max-w-xl mx-auto">Invite tes ami·es. Quand 3 d'entre eux rejoignent Kinky, tu débloques le badge Ambassadeur·rice + 10€ de réduc shop.</p>
      </header>
      ...
      <div className="bg-fuchsia-500/10 border border-fuchsia-500/30 rounded-2xl p-5 text-center">
        <p className="text-sm text-zinc-200 mb-3">Pour générer ton lien unique, tu dois d'abord avoir un compte Kinky :</p>
