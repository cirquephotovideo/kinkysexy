...
export const metadata = { title: 'Signalement collaboratif — Kinky' };
  ...
  return (
    <main className="container-wide py-12 max-w-2xl">
      <header className="text-center mb-6">
        ...
        <p className="text-zinc-400 text-sm mt-2 max-w-xl mx-auto">Anonyme. Modéré par Kinky avant publication. Aide la communauté à éviter les endroits/personnes hostiles.</p>
      </header>
      <SubmissionForm
        kind="report-place"
