      ...
      <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-5 space-y-3">
        ...
        {audioUrl && (
          <div className="bg-zinc-950 border border-fuchsia-500/30 rounded-lg p-3">
            ...
            <a href={audioUrl} download="temoignage-kinky.mp3" className="block text-center text-fuchsia-400 hover:underline text-xs mt-2">⬇ Télécharger MP3</a>
          </div>
        )}
      </div>
      <p className="text-[11px] text-zinc-400 mt-3 text-center">💡 Pour avoir une vraie vidéo : ouvre <strong>QuickTime → Nouvel enregistrement écran</strong>, puis lance ton avatar Kinky avec ce texte sur <a href="/admin/ai/avatar" className="text-fuchsia-400 underline">/admin/ai/avatar</a>.</p>
    </main>
  );
}
