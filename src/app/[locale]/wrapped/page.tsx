...
export const metadata = { title: 'Mon Kinky Wrapped' };
  ...
  if (!s?.user) {
    return (
      <main className="container-wide py-20 max-w-md text-center">
        ...
        <h1 className="text-2xl font-bold mb-2">✨ Mon Kinky Wrapped</h1>
        <p className="text-zinc-400 mb-4">Connecte-toi pour voir ton année Kinky : témoignages, soutiens, partages, badges débloqués…</p>
  ...
  return (
    <main className="container-wide py-12 max-w-3xl">
      <header className="text-center mb-8">
        ...
        <p className="text-zinc-400 text-sm">Ton année Kinky en chiffres</p>
      </header>
