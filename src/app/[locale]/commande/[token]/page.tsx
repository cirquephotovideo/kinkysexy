...
export const metadata = { title: 'Suivi de ma commande — KinkySexy' };
    ...
    <main className="min-h-screen py-12">
      <div className="container-tight">
        ...
        <p className="text-center text-white/40 text-sm mt-8">
          Une question ? Contacte-nous : <a href="mailto:contact@kinkysexy.org" className="text-brand-pink hover:underline">contact@kinkysexy.org</a>
        </p>
      </div>
    </main>
  );
