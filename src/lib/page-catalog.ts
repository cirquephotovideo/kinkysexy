...
export const PAGE_CATALOG: PageMeta[] = [
  ...
  { slug: 'message',               label: 'Le message',           desc: 'Manifeste Kinky',                        emoji: '📖', category: 'home' },
  ...
  { slug: 'kinky-local',             label: 'Kinky local',            desc: 'Activité locale',                     emoji: '📌', category: 'pro' },
  ...
  // ─── SHOP / FUNDING ───────────────────────────────
  { slug: 'boutique',              label: 'Boutique',             desc: 'Articles Kinky',                        emoji: '🛍️', category: 'shop' },
