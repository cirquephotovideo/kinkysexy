...
.kinky-rainbow-bar { background: linear-gradient(90deg,#e40303,#ff8c00,#ffed00,#008026,#004dff,#750787); height: 6px; position: fixed; top: 0; left: 0; right: 0; z-index: 9999; animation: kinky-shimmer 3s infinite; }`,
...
.kinky-spook { animation: kinky-flicker 2s infinite; }
@keyframes kinky-flicker { 0%,100% { opacity: 1 } 50% { opacity: 0.7 } }`,
  ...
  {
    slug: 'neon-cathedral', name: '⛪ Neon Cathedral', description: 'Le thème par défaut Kinky — violet/cyan/rose néon',
    category: 'aesthetic',
...
.kinky-glitch { text-shadow: 2px 0 #ff003c, -2px 0 #00f0ff; }`,
    autoActivate: false, daysBefore: 0, durationDays: 0
  },
  {
