/**
 * Données mock pour les 3 modes du réseau social Kinky Connect.
...
export const MOCK_PRO_DIRECTORY: MockProRecord[] = [
  {
    ...
    pitch: 'Psychologue, 12 ans d\'accompagnement personnes LGBT issues de milieux religieux. Premier RDV gratuit pour membres Kinky.',
