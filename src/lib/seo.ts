...
const KEYWORDS = [
  'KinkySexy', 'foi inclusive', 'religion LGBT', 'église inclusive',
...
export const organizationJsonLd = {
  ...
  sameAs: [
    'https://www.facebook.com/kinkysexy',
    'https://www.instagram.com/kinkysexy',
    'https://twitter.com/KinkySexy'
  ],
  contactPoint: {
    '@type': 'ContactPoint',
    contactType: 'customer support',
    email: 'contact@kinkysexy.org',
...
export function photoJsonLd(p: { id: string; placeName?: string | null; caption?: string | null; city?: string | null; country?: string | null; imageUrl: string; createdAt: Date }) {
  return {
    ...
    name: p.placeName || 'Photo KinkySexy',
