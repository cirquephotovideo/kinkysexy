...
export const minioClient = new Minio.Client({
  ...
  accessKey: process.env.S3_ACCESS_KEY || 'kinkyminio',
  secretKey: process.env.S3_SECRET_KEY || 'kinkyminio-secret'
});

export const BUCKET = process.env.S3_BUCKET || 'kinkysexy';
