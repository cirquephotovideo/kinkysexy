...
const RULES: MetaRule[] = [
  ...
  { match: '/admin/pro/import-events', meta: {
    title: 'Import events Facebook', desc: 'Sync de tes events Facebook vers ton agenda Kinky',
  ...
  { match: '/admin/import', meta: {
    title: 'Import en masse', desc: 'CSV, JSON, GDoc → DB Kinky',
  ...
  { match: '/admin/news', meta: {
    title: 'Actualités', desc: 'Articles, posts, blog Kinky',
  ...
  { match: '/admin/connect', meta: {
    title: 'Dashboard Connect', desc: 'Réseau social Kinky · communauté · matches · live',
  ...
  { match: '/admin/ai/knowledge', meta: {
    title: 'Cerveau de Kinky (RAG)', desc: 'Knowledge base · embeddings Gemini · 2329+ chunks',
  ...
  { match: '/admin/ai/avatar', meta: {
    title: 'Kinky Live (avatar vidéo)', desc: 'Génération de vidéos avec ton avatar IA',
  ...
  { match: '/admin', exact: true, meta: {
    title: 'Tableau de bord', desc: 'Vue d\'ensemble du back-office Kinky',
