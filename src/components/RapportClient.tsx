...
export function RapportClient({ stats }: { stats: Stats }) {
      ...
      if (chartRef.current) {
        new Chart(chartRef.current, {
          ...
          data: {
            ...
            datasets: [
              { label: 'Kinky Connect', data: [10, 9, 9, 10, 10, 10, 10, 8, 10], backgroundColor: '#d4537e' },
      ...
      if (radarRef.current) {
        new Chart(radarRef.current, {
          ...
          data: {
            ...
            datasets: [{ label: 'Couverture Kinky', data: [95, 92, 75, 70, 90, 100, 80, 60, 85, 88], backgroundColor: 'rgba(212,83,126,0.2)', borderColor: '#d4537e', borderWidth: 2 }]
          },
  ...
  function share() {
    if (navigator.share) navigator.share({ title: 'Kinky — Rapport projet', url: shareUrl });
    ...
    <div style={{ minHeight: '100vh', background: '#09090b', color: '#fafafa', fontFamily: 'system-ui, -apple-system, sans-serif' }}>
        ...
        <div className="relative max-w-6xl mx-auto px-6 py-10">
          <div className="flex items-start justify-between gap-4 flex-wrap" style={{ display: 'flex', flexWrap: 'wrap', gap: 16, justifyContent: 'space-between' }}>
            <div>
              ...
              <h1 className="text-4xl font-display font-black mb-2" style={{ fontSize: 36, fontWeight: 900, marginBottom: 8 }}>🌈 KinkySexy</h1>
      ...
      <main className="max-w-6xl mx-auto px-6 py-10 space-y-12">
        ...
        <section className="bg-zinc-900 border border-zinc-800 rounded-3xl p-6">
          ...
          <p className="text-sm text-zinc-400 mb-4">Kinky Connect face à Facebook · Tinder · LinkedIn — note sur 10 par fonctionnalité.</p>
          <div className="h-72"><canvas ref={chartRef} /></div>
          <p className="text-xs text-zinc-500 mt-3">💡 Kinky est le seul à combiner les 3 modes (social + rencontres + pro) avec un focus inclusif religieux et une modération IA dédiée.</p>
        </section>
        ...
        <footer className="text-center text-xs text-zinc-500 pt-8 border-t border-zinc-800">
          ...
          <p className="mt-2">🌈 <a href="https://kinky.pixeeplay.com" className="text-fuchsia-400 hover:underline">kinky.pixeeplay.com</a> — KinkySexy</p>
        </footer>
      </main>
    </div>
  );
