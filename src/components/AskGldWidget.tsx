      ...
      {!open && (
        ...
        >
          ...
          <span className="relative flex items-center gap-2 bg-brand-pink hover:bg-brand-rose text-white pl-4 pr-5 py-3 rounded-full font-bold shadow-[0_0_30px_rgba(255,43,177,.6)]">
            <Sparkles size={18} /> Demandez à Kinky
          </span>
        </button>
      )}
        ...
        >
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <div>
                <div className="font-bold text-sm" style={{ color: 'var(--fg)' }}>Demandez à Kinky</div>
          ...
          <div ref={scrollRef} className="flex-1 overflow-y-auto p-4 space-y-3 text-sm">
            {history.length === 0 && (
              <div className="space-y-3">
                <p className="text-xs" style={{ color: 'var(--fg-muted)' }}>
                  Bonjour 🌈 Je suis Kinky, l'assistant du mouvement. Je réponds avec apaisement aux questions sur la foi et la diversité.
            ...
            {busy && (
              <div className="flex justify-start">
                ...
                >
                  <Loader2 size={12} className="animate-spin" /> Kinky réfléchit…
                </div>
              </div>
            )}
          </div>
