      ...
      <div className="flex-1 min-w-0 flex flex-col relative z-10">
        ...
        >
          ...
          <div className="flex items-center gap-2 lg:hidden">
            ...
            <span className="font-display font-bold">Kinky Admin</span>
          </div>
  ...
  return (
    <noscript>
      <div className="p-6 m-6 bg-amber-500/10 border border-amber-500/30 rounded-xl">
        ...
        <p className="text-sm">Le back-office Kinky nécessite JavaScript. Active-le ou utilise un navigateur récent (Safari 17+, Chrome 120+).</p>
      </div>
    </noscript>
  );
}
