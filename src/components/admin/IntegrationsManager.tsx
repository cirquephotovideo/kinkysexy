...
const INTEGRATIONS: Integration[] = [
  ...
  },
  {
    ...
    setupInstructions: [
      ...
      'Renseigne owner/repo de la forme `pixeeplay/kinkysexy`.'
    ],
    fields: [
      { key: 'integrations.github.token', label: 'Personal Access Token', type: 'password', placeholder: 'ghp_…' },
      { key: 'integrations.github.repo', label: 'Repository (owner/repo)', placeholder: 'pixeeplay/kinkysexy' }
    ]
  },
  {
    id: 'notion',
  ...
  },
  {
    ...
    setupInstructions: [
      ...
      'URL : https://kinky.pixeeplay.com/api/webhooks/stripe',
