  ...
  return (
    <div className="p-6 md:p-8 max-w-6xl space-y-6">
      <header className="flex items-center justify-between flex-wrap gap-3">
        <div>
          <div className="flex items-center gap-3 mb-1">
            ...
            <h1 className="text-3xl font-display font-bold">Traductions Kinky</h1>
      ...
      <div className="text-[10px] text-zinc-500 bg-zinc-900/50 border border-zinc-800 rounded-lg p-3">
        ...
        En cliquant « Traduire avec Gemini », Kinky prend le row source et appelle l'API Gemini pour générer les versions manquantes, puis les enregistre en base.
