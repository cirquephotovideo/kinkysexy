'use client';
/**
 * BrainViz — visualisation cinématique du cerveau RAG « Demandez à Kinky ».
 *
    ...
    <header className="mb-8 flex items-center justify-between">
      <div>
        ...
        <p className="mt-1 text-sm text-slate-400">
          Vue temps réel du système RAG « Demandez à Kinky » · snapshot {new Date(generatedAt).toLocaleTimeString()}
        </p>
      </div>
