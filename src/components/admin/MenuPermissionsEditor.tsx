...
const ALL_ITEMS: { href: string; label: string; group: string; alwaysVisible?: boolean; isNew?: boolean }[] = [
  ...
  // Kinky Connect
  { href: '/admin/connect',                label: 'Dashboard Connect',           group: 'Kinky Connect' },
  { href: '/admin/connect/moderation',     label: 'Modération posts/messages',   group: 'Kinky Connect' },
  { href: '/admin/establishments',         label: 'Établissements (annuaire)',   group: 'Kinky Connect' },
  ...
  { href: '/admin/ai/avatar',               label: 'Kinky Live (avatar vidéo)',            group: 'IA & Outils' },
...
const GROUPS = [
  ...
  { name: 'Kinky Connect',      gradient: 'from-rose-500 to-violet-500' },
