    ...
    <div className="p-6 md:p-8 max-w-6xl space-y-6">
      ...
      <section className="bg-gradient-to-br from-amber-500/10 via-fuchsia-500/5 to-violet-500/10 border border-amber-500/30 rounded-2xl p-5">
        <h3 className="font-bold mb-3 flex items-center gap-2">
          <Sparkles size={14} className="text-amber-300" /> Cas d'usage prêts pour Kinky
        </h3>
        <div className="grid sm:grid-cols-3 gap-3 text-xs">
          ...
          <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-3">
            ...
            <p className="text-zinc-400 mt-1">User envoie audio + texte → avatar Kinky raconte le témoignage avec sous-titres FR/EN/ES/PT.</p>
          </div>
        </div>
      </section>
