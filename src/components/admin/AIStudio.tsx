...
function CaptionTab() {
  ...
  return (
    <Card hint="Colle une URL d'image (de la galerie ou ailleurs). Gemini Vision la décrit en 80 mots avec hashtags inclusifs.">
      <input className="w-full bg-zinc-950 border border-zinc-800 rounded-lg px-3 py-2 text-sm" placeholder="https://kinky.pixeeplay.com/api/storage/..." value={url} onChange={(e) => setUrl(e.target.value)} />
