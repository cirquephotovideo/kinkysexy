    ...
    <div className="p-6 md:p-8 max-w-7xl space-y-6">
      ...
      <header>
        <div className="flex items-center gap-3 mb-1">
          ...
          <h1 className="text-3xl font-display font-bold">Cerveau de Kinky</h1>
        ...
        <p className="text-zinc-400 text-sm max-w-3xl">
          La bibliothèque que tu donnes ici devient la <strong>seule source de vérité</strong> du chat « Demandez à Kinky ».
...
const DEFAULT_PROMPT = `Tu es la voix officielle du mouvement « KinkySexy » (Kinky).
...
GARDE-FOUS :
- Si la question concerne un sujet hors foi/inclusion/diversité/spiritualité (ex: météo, sport, technique pure), réponds : « Je suis là pour parler de foi, d'amour et d'inclusion. Pour [sujet], je te conseille de chercher ailleurs. Veux-tu plutôt qu'on parle de [propose un thème Kinky pertinent] ? »
    ...
    <div className="grid lg:grid-cols-[1fr_420px] gap-6">
      ...
      <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-5 space-y-3">
        <div className="flex items-center justify-between">
          <div>
            <h3 className="font-bold flex items-center gap-2"><Sparkles size={16} className="text-violet-400" /> Prompt système — la voix de Kinky</h3>
