 ...
 *
 * Différence vs le chat public "Demandez à Kinky" : ici tout est exposé en clair
      ...
      <div className="mx-auto max-w-5xl px-4 py-6">
        <header className="mb-6 flex items-start justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-zinc-400">
              Teste le cerveau Kinky en voyant tout ce qui se passe en coulisses : chunks matchés, scores, prompt envoyé.
            </p>
          </div>
        </header>
        ...
        <div className="mb-4 rounded-2xl bg-violet-950/30 p-4 text-xs text-violet-200 ring-1 ring-violet-800/50">
          ...
          <ol className="ml-4 list-decimal space-y-1">
            ...
            <li>
              <strong>Mode prod</strong> = comportement réel du chat « Demandez à Kinky ». <strong>Mode test admin</strong> = pas de verrou, le RAG répond à tout.
            </li>
            <li>
        ...
        <div className="mb-4 grid gap-3 md:grid-cols-2">
          ...
          >
            ...
            <p className="mt-2 text-xs text-emerald-100">
              Comportement <strong>identique au chat public</strong>. System prompt Kinky complet (verrou foi/inclusion). Questions hors thème → redirigées. Score &lt; 0.55 → marquée zone aveugle.
            </p>
          </button>
