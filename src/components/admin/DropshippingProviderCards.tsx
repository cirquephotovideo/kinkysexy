...
const PROVIDERS: Provider[] = [
  {
    ...
    steps: [
      ...
      'Crée tes designs avec leur outil ou importe nos visuels Kinky',
      ...
      'Dans chaque produit Kinky : choisis « Gelato » + colle le Product UID + ton coût d\'achat'
    ],
  ...
  },
  {
    ...
    name: 'TPOP',
    emoji: '🌱',
    tagline: 'Éthique français — aligné valeurs Kinky',
    ...
    pros: [
      ...
      'Aligné parfait avec le message Kinky ❤️',
      'Pas d\'abonnement'
    ],
    cons: [
    ...
    steps: [
      ...
      'Colle la clé ci-dessous, teste la connexion',
      'Dans chaque produit Kinky : choisis « TPOP » + colle l\'ID variant + ton coût d\'achat'
    ],
  ...
  },
  {
    ...
    steps: [
      ...
      'Dans chaque produit Kinky : choisis « Printful » + sync_variant_id + ton coût d\'achat'
    ],
      ...
      <div className="p-5 space-y-4">
        ...
        {productCount > 0 && (
          <div className="text-center text-xs text-zinc-500 pt-1">
            ...
            <strong className="text-white">{productCount}</strong> produit{productCount > 1 ? 's' : ''} Kinky utilise{productCount > 1 ? 'nt' : ''} ce fournisseur
          </div>
        )}
      </div>
    </div>
