    ...
    <div className="p-6 md:p-8 max-w-5xl space-y-6">
      ...
      <section className="bg-zinc-900 border border-zinc-800 rounded-2xl p-5">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-3">
          <input value={newCoupon.code} onChange={(e) => setNewCoupon({ ...newCoupon, code: e.target.value })} placeholder="CODE (ex: Kinky2026)" className="bg-zinc-950 border border-zinc-700 rounded-lg px-3 py-2 text-sm uppercase" />
