        ...
        <div className="bg-zinc-900 ring-1 ring-zinc-800 rounded-2xl p-4 space-y-3">
          ...
          <div className="grid grid-cols-2 gap-2">
            <label className="text-xs"><span className="block text-[10px] text-zinc-500 uppercase font-bold mb-1">Label</span>
              <input value={form.label} onChange={(e) => setForm({ ...form, label: e.target.value })} placeholder="Contact Kinky" className="w-full bg-zinc-950 border border-zinc-800 rounded-lg px-3 py-2 text-xs" />
            </label>
            <label className="text-xs"><span className="block text-[10px] text-zinc-500 uppercase font-bold mb-1">Email</span>
              <input value={form.email} onChange={(e) => setForm({ ...form, email: e.target.value, imapUser: form.imapUser || e.target.value, smtpUser: form.smtpUser || e.target.value })} placeholder="contact@kinky.pixeeplay.com" className="w-full bg-zinc-950 border border-zinc-800 rounded-lg px-3 py-2 text-xs" />
            </label>
          </div>
