...
const GROUPS: Group[] = [
  {
    ...
    fields: [
      { key: 'site.title', label: 'Nom du site', placeholder: 'KinkySexy' },
      { key: 'site.tagline', label: 'Slogan', placeholder: 'Dieu est amour. La foi se conjugue au pluriel.' },
      { key: 'campaign.hashtag', label: 'Hashtag de campagne', placeholder: '#KinkySexy' },
      { key: 'site.contactEmail', label: 'Email de contact public', placeholder: 'hello@kinkysexy.com' }
    ]
  },
  {
    title: 'Gemini IA',
  ...
  {
    title: 'HeyGen (avatar vidéo « Kinky Live »)',
    icon: Sparkles, category: 'ai',
    description: 'Avatar humain qui répond aux visiteurs en vidéo, branché sur le RAG. Compte gratuit sur https://www.heygen.com puis Settings → API → Generate token. Configure ensuite l\'avatar et la voix dans IA & Outils → Kinky Live.',
    fields: [
  ...
  },
  {
    ...
    icon: Sparkles, category: 'ai',
    description: 'Avatar streaming temps-réel — successeur de HeyGen Interactive. Compte sur https://app.liveavatar.com/developers puis API Keys → Create Key. Configure ensuite l\'avatar dans IA & Outils → Kinky Live.',
    fields: [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'integrations.resend.from', label: 'Adresse expéditeur', placeholder: '"KinkySexy" <hello@kinkysexy.com>' },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'mail.subdomains', label: 'Sous-domaines (CSV)', placeholder: 'kinky.pixeeplay.com, mail.pixeeplay.com' },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'mail.smtp.from', label: 'Adresse "From" affichée', placeholder: '"Kinky" <contact@pixeeplay.com>', help: 'Doit être autorisée dans Gmail "Send mail as"' }
    ]
  },
  {
    title: '🌐 Domaines & sous-domaines',
    icon: Globe, category: 'logistics',
    description: 'Liste des domaines connectés à Kinky. Configuration DNS chez ton registrar (OVH, Gandi, Namecheap, etc.).',
    fields: [
      { key: 'domains.primary', label: 'Domaine principal', placeholder: 'kinky.pixeeplay.com' },
      { key: 'domains.aliases', label: 'Domaines secondaires (CSV)', placeholder: 'kinkysexy.com, kinkysexy.fr' },
      { key: 'domains.subdomains', label: 'Sous-domaines actifs (CSV)', placeholder: 'connect.kinky.pixeeplay.com, pro.kinky.pixeeplay.com', help: 'Tous les sous-domaines avec records DNS A/CNAME' },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'integrations.busyx.trackingDomain', label: 'Domaine tracking', placeholder: 'go.kinky.pixeeplay.com', help: 'Sous-domaine pour les liens raccourcis' }
    ]
  },
  {
  ...
  },
  {
    title: '🌱 TPOP',
    icon: Truck, category: 'dropshipping',
    description: 'Print-on-Demand français éthique : 100% bio, vegan, packaging recyclé — production France/Pays-Bas. Idéal positionnement éthique Kinky. Compte sur https://www.tpop.com',
    fields: [
