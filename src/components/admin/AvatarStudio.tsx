    ...
    <div className="p-6 md:p-8 max-w-7xl space-y-6">
      ...
      <header>
        <div className="flex items-center gap-3 mb-1">
          ...
          <h1 className="text-3xl font-display font-bold">Kinky Live — Avatar vidéo</h1>
              ...
              {hasLiveAvatar && (
                <>
                  ...
                  <button
                    ...
                    title="Envoie tout le contenu de Cerveau de Kinky (RAG) à LiveAvatar.com pour que l'avatar connaisse tes textes"
                  >
                    🧠 Synchroniser le Cerveau de Kinky vers LiveAvatar
                  </button>
                  <button
                    onClick={async () => {
        ...
        <div className="space-y-6">
          ...
          <section className="bg-zinc-900 border border-zinc-800 rounded-2xl p-5 space-y-4">
            ...
            <label className="flex items-center gap-3 cursor-pointer">
              ...
              <div>
                <div className="font-bold text-sm">Activer le widget « Kinky Live » côté visiteur</div>
