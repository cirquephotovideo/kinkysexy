    ...
    <main className="container-wide py-12 max-w-5xl">
      <header className="text-center mb-6">
        ...
        <p className="text-zinc-400 text-sm mt-2 max-w-2xl mx-auto">
          Chaque prière, chaque intention, chaque bougie virtuelle fait avancer la communauté Kinky sur un chemin de pèlerinage. Marchons ensemble.
        </p>
      </header>
      ...
      <div className="mt-8 bg-zinc-900/60 border border-zinc-800 rounded-xl p-4 text-xs text-zinc-400 text-center">
        💡 Le Camino est collectif. Chaque action dans Kinky (rejoindre un cercle, partager une intention, allumer une bougie) ajoute automatiquement 1 km à un chemin choisi.
      </div>
    </main>
  );
}
