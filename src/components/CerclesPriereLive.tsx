...
const CIRCLES = [
  ...
  { id: 'orthodox',    label: 'Orthodoxe inclusif',   emoji: '☦️',  color: '#7c3aed', day: 'Dimanche',        time: '18h CET',     hosts: 'Cercle œcuménique Kinky',                  url: '/contact' },
  ...
  { id: 'interfaith',  label: 'Inter-religieux',      emoji: '🌍',  color: '#22d3ee', day: '1er dim. du mois', time: '17h CET',    hosts: 'Kinky',                                    url: '/contact' }
];
