  ...
  return (
    <main className="container-wide py-12 max-w-5xl">
      ...
      <div className="mt-4 bg-amber-500/10 border border-amber-500/30 rounded-xl p-3 text-xs text-amber-200">
        ⚠️ Important : ces personas sont des assistants IA, pas des officiants religieux. Pour une confession sacramentelle, un avis halakhique, fatwa ou guidance pastorale officielle, consulte un·e officiant·e humain·e (annuaire en construction sur Kinky). En cas de détresse psychologique : <strong>3114</strong> (France, 24h/24, gratuit) ou helpline locale.
      </div>
    </main>
  );
}
