        ...
        <div className="absolute bottom-0 left-0 right-0 z-10 px-4 md:px-8 pb-6">
          <div className="max-w-5xl mx-auto flex items-end gap-4">
            ...
            <div className="relative shrink-0">
              ...
              {v.verified && (
                <div className="absolute -bottom-1 -right-1 bg-cyan-500 rounded-full p-1 border-2 border-zinc-950" title="Vérifié par Kinky">
          ...
          <div className="grid lg:grid-cols-[1fr_320px] gap-6">
            <div className="space-y-5">
              ...
              <InfoBlock title="Identité" icon={Info}>
                ...
                {v.verified && <Row label="Vérifié" val="✓ par l'équipe Kinky" />}
              </InfoBlock>
