...
const SCENARIOS = [
  ...
  { id: 'religion',  title: '🙏 Conflit foi / orientation', steps: [
    ...
    'Notre RAG « Demandez à Kinky » t\'aide aussi sur ces sujets — ouvre le widget chat.'
  ]},
  { id: 'isolement', title: '🌑 Je me sens seul·e', steps: [
    ...
    'Notre AI Avatar Kinky est là 24/7 pour parler — ouvre le widget chat.'
  ]},
  ...
  return (
    <div className="space-y-3">
      <div className="bg-violet-500/10 border border-violet-500/30 rounded-xl p-3">
        ...
        <p className="text-[11px] text-violet-200/90">Partage anonymement ce que tu vis. La communauté Kinky t'enverra du soutien (sans jugement, modéré).</p>
    ...
    <div className="space-y-3">
      ...
      <a href="/lieux" className="block bg-zinc-900 hover:bg-zinc-800 border border-zinc-800 rounded-xl p-3 transition">
        <div className="flex items-center justify-between">
          <div>
            <div className="font-bold text-sm">🏳️‍🌈 Annuaire complet Kinky</div>
