...
type Props = {
  ...
  hashtags?: string; // ex: 'KinkySexy,Inclusion'
};
 ...
 */
export function SharePhoto({ url, title = 'Photo — KinkySexy', hashtags = 'KinkySexy,FoiEtDiversite' }: Props) {
  const [copied, setCopied] = useState(false);
  const [open, setOpen] = useState(false);

  const text = `${title} 🌈 #KinkySexy`;
