...
/**
 * Widget public « Kinky Live » — un avatar HeyGen qui répond en vidéo,
 * piloté par le RAG « Demandez à Kinky ».
 *
        ...
        >
          ...
          <div className="p-4 flex items-center justify-between text-white"
            ...
            <div className="flex items-center gap-2">
              <Sparkles size={18} />
              <div>
                <div className="font-bold text-sm">Kinky Live</div>
          ...
          <div className="aspect-[3/4] relative flex items-center justify-center"
            ...
            {state === 'idle' && (
              <div className="text-center px-6">
                ...
                <p className="text-xs text-zinc-500 mt-1">L'avatar te répondra en vidéo, dans le ton de Kinky.</p>
              </div>
            )}
