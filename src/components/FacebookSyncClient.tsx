    ...
    <>
      <header className="mb-6">
        ...
        <p className="text-zinc-400 text-sm max-w-3xl">
          3 méthodes pour récupérer les événements LGBT-friendly de ton feed Facebook (où tu es invité par les établissements) vers Kinky, en brouillon ou auto-publié.
        </p>
      </header>
...
function TabB({ userEmail, siteUrl }: { userEmail: string; siteUrl: string }) {
  const inboundEmail = 'events@kinky.pixeeplay.com';
  return (
    <div className="space-y-5">
      <section className="bg-zinc-900 border border-cyan-500/30 rounded-2xl p-5">
        ...
        <p className="text-sm text-zinc-400 mb-4">
          Facebook t'envoie un email à chaque invitation d'event. On configure une règle qui forward ces emails à Kinky,
        ...
        <div className="bg-amber-500/10 border border-amber-500/30 rounded-lg p-3 mt-4 text-xs text-amber-200">
          ...
          <strong>Côté admin Kinky</strong> : faut configurer un service inbound email (Resend Inbound, Mailgun Routes, ou Cloudflare Email Workers)
